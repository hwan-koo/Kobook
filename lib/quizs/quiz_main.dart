...
import 'package:crepas/quizs/quiz_result.dart';
...
class QuizMain extends ConsumerStatefulWidget {
  ...
  @override
  QuizMainState createState() => QuizMainState();
}

class QuizMainState extends ConsumerState<QuizMain> {
  @override
  void initState() {
