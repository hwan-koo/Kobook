...
class AllTale5ProviderEn extends AsyncNotifier<Map<String, dynamic>> {
...
final allTale5ProviderModelEn =
    AsyncNotifierProvider<AllTale5ProviderEn, Map<String, dynamic>>(
  () => AllTale5ProviderEn(),
);
